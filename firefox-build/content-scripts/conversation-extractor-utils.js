    ...
    setHTML(modal, `
      ...
      ">
        <h3 style="margin: 0 0 16px 0; font-size: 18px; font-weight: 600;">
          ${browser.i18n.getMessage('dlgDuplicateTitle')}
        </h3>
        <p style="margin: 0 0 8px 0; font-size: 14px; line-height: 1.5;">
          ${browser.i18n.getMessage('dlgDuplicateDesc')}
        </p>
        <p style="margin: 0 0 16px 0; font-size: 13px; color: #666; font-weight: 500;">
          "${title}"<br>
          <span style="font-size: 12px;">${browser.i18n.getMessage('dlgDuplicateSaved', [existingDate])}</span>
        </p>
        <p style="margin: 0 0 20px 0; font-size: 14px; line-height: 1.5;">
          ${browser.i18n.getMessage('dlgDuplicateQuestion')}
        </p>
        <div style="display: flex; gap: 12px;">
          ...
          <button id="insidebar-dup-overwrite" style="
            ...
            font-weight: 500;
          ">
            ${browser.i18n.getMessage('btnOverwrite')}
          </button>
        </div>
      </div>
    `;
