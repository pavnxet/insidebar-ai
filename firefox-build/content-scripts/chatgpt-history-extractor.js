...
(function() {
  ...
  async function handleSaveClick(e) {
    ...
    console.log('[ChatGPT Extractor] browser object exists?', typeof browser !== 'undefined');
    console.log('[ChatGPT Extractor] browser.runtime exists?', typeof browser?.runtime !== 'undefined');

    if (!saveButton) return;

    // Check if browser API is available
    if (typeof browser === 'undefined' || !browser.runtime) {
      console.error('[ChatGPT Extractor] Browser extension API not available');
    ...
    try {
      ...
      if (duplicateCheck.isDuplicate) {
        ...
        if (existingContent === newContent) {
          ...
          saveButton.replaceChildren(...origNodes);
          return;
        }
      ...
      try {
        ...
        console.error('[ChatGPT Extractor] Browser runtime error:', sendError);
