...
ft Copilot Conversation History Extractor
...
(function() {
  ...
  async function handleSaveClick(e) {
    ...
    if (typeof browser === 'undefined' || !browser.runtime) {
      console.error('[Copilot Extractor] Browser extension API not available');
    ...
    try {
      ...
      try {
        ...
        console.error('[Copilot Extractor] Browser runtime error:', sendError);
