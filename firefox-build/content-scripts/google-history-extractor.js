...
AI Mode Conversation History Extractor
...
(function() {
  ...
  async function handleSaveClick(e) {
    ...
    if (typeof browser === 'undefined' || !browser.runtime) {
      console.error('[Google Extractor] Browser extension API not available');
    ...
    try {
      ...
      try {
        ...
        console.error('[Google Extractor] Browser runtime error:', sendError);
