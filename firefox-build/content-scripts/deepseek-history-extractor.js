...
k Conversation History Extractor
...
(function() {
  ...
  async function handleSaveClick(e) {
    ...
    if (typeof browser === 'undefined' || !browser.runtime) {
      console.error('[DeepSeek Extractor] Browser extension API not available');
    ...
    try {
      ...
      try {
        ...
        console.error('[DeepSeek Extractor] Browser runtime error:', sendError);
